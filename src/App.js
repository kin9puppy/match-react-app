            ...
            <div className="App">
                <div className="container">
                    ...
                    <div className="row name-header" onClick={this._onClick.bind(this)}>
                        Daisy Buchanan {this.props.store.count}
                    </div>
                    <div className="row main">
                        ...
                        <div className="col-md-8 filter-options">
                            ...
                            <div className="row about">
                                ...
                                <div><b>City:</b> Melbourne</div>
                                <div><b>Country:</b> Australia</div>
                                <div><b>Interests:</b> Soccer, Jogging, Wine</div>
                                <div><b>Pets:</b> My dog Bruno</div>
                                <div><b>About me:</b> I am a super athletic girl who likes to have fun, and am looking for a guy who is athletic and likes to be outdoors.</div>
                            </div>
                        </div>
                    </div>
                </div>
